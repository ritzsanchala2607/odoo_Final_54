module.exports = (sequelize, DataTypes) => {
  const Court = sequelize.define('Court', {
    ...
    allow_per_hour: { type: DataTypes.BOOLEAN, defaultValue: true },
    allow_per_person: { type: DataTypes.BOOLEAN, defaultValue: false },
    refund_ratio_override: { type: DataTypes.DECIMAL(5, 2) },
