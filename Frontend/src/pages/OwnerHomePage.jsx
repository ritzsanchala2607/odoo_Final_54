...
const navigate = useNavigate();
  ...
  const handleVenueSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/venues/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
        credentials: 'include', // This will include the HTTP-only cookie
      ...
      if (!response.ok) {
        ...
        alert(errorData.message || 'Failed to create venue');
        return;
      }
  ...
  const [venues, setVenues] = useState([
    {
      ...
      maxCourts: 6,
      courts: [
        { id: 1, name: "Court A", sport: "Badminton", capacity: 4, price: 500 },
      ],
    },
    {
      id: 2,
  ...
  const courtBookingData = [
    {
      court: "Arena Sports Complex - Court A",
      venue: "Arena Sports Complex",
      bookings: 245,
      sport: "Badminton",
      revenue: 12250,
    ...
    {
      court: "Metro Sports Hub - Court 1",
    ...
    {
      court: "Elite Sports Center - Court 3",
  ...
  const customerReviews = [
    {
      ...
      rating: 5,
      comment:
        "Excellent facilities and very clean courts. Staff was helpful too!",
      date: "2 hours ago",
      sport: "Badminton",
      verified: true,
    },
    {
      ...
      court: "Court 1",
      rating: 4,
      comment: "Good court quality but parking could be better.",
      date: "5 hours ago",
      sport: "Tennis",
      verified: true,
    },
    {
      ...
      court: "Field B",
      rating: 5,
      comment: "Amazing turf quality! Perfect for weekend matches.",
      date: "1 day ago",
      sport: "Football",
      verified: false,
    },
    {
      ...
      rating: 3,
      comment:
        "Court was okay but AC wasn't working properly. Need better maintenance.",
      date: "1 day ago",
      sport: "Badminton",
      verified: true,
    },
    {
      ...
      court: "Court 2",
      rating: 4,
      comment: "Good experience overall. Will book again for sure.",
      date: "2 days ago",
      sport: "Basketball",
      verified: true,
    },
    {
      ...
      court: "Court A",
      rating: 2,
      comment: "Poor maintenance and booking system was confusing.",
      date: "2 days ago",
      sport: "Tennis",
      verified: true,
    },
    {
      ...
      court: "Field 1",
      rating: 5,
      comment: "Outstanding cricket pitch quality! Will definitely return.",
      date: "3 days ago",
      sport: "Cricket",
      verified: true,
    },
    {
      ...
      court: "Court B",
      rating: 1,
      comment: "Very disappointed with the service and court condition.",
      date: "3 days ago",
      sport: "Badminton",
      verified: false,
    },
...
//   const totalBookings = courtBookingData.reduce(
//     (sum, court) => sum + court.bookings,
//     0
//   );
  const totalRevenue = courtBookingData.reduce(
    (sum, court) => sum + court.revenue,
    0
  );
  const averageRating = (
    courtBookingData.reduce((sum, court) => sum + court.rating, 0) /
    courtBookingData.length
  ).toFixed(1);
  const averageUtilization = Math.round(
    courtBookingData.reduce((sum, court) => sum + court.utilization, 0) /
      courtBookingData.length
  );
  ...
  const getTrendIcon = (trend) => {
    switch (trend) {
      ...
      default:
        return <Activity className="trend-stable" />;
    }
  };
                  ...
                  {performanceFilters.map((filter) => (
                    <button
                      ...
                      className={`filter-button ${
                        performanceFilter === filter.id ? "active" : ""
                      }`}
                    >
                      {filter.label}
                    </button>
          ...
          <div className="insights-section">
            ...
            <div className="insights-grid">
              <div className="card reviews-card">
                <div className="card-header">
                  <h3>
                    Customer Reviews ({getFilteredReviews().length} reviews)
                  </h3>
                </div>
                <div className="card-body">
        ...
        return (
          <div className="predictions-section">
            <div className="prediction-overview">
              ...
              <p>
                Machine learning insights and forecasting for the next 7 days
              </p>
            </div>
              ...
              {predictionMetrics.map((pred, index) => (
                <div
                  ...
                  className={`prediction-card ${
                    selectedPrediction === pred.id ? "selected" : ""
                  }`}
                  onClick={() =>
              ...
              {venues.map((venue) => (
                <div key={venue.id} className="venue-card">
                  <div className="venue-info">
                    ...
                    <p>
                      Courts: {venue.courts.length} / {venue.maxCourts}
                    </p>
                  </div>
